...
> Хоть он и нужен для обработки всего одного запроса, справочной информации и хороших отзывов о нем в сети было предостаточно, что бы прочитать основную часть документации и бысторо написать обработчик сетевого запроса.
